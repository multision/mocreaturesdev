...
public class Ruin3Structure {
    ...
    public static void addFeatureToBiomes(BiomeLoadingEvent event) {
        ...
        if (new ResourceLocation("mocreatures:wyvernlair_mountains").equals((Object)event.getName())) {
            biomeCriteria = true;
        }
        if (new ResourceLocation("mocreatures:wyvernlair_desertlands").equals((Object)event.getName())) {
            biomeCriteria = true;
        }
        if (!biomeCriteria) {
            return;
    ...
    private static class FeatureRegisterHandler {
        ...
        public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
                ...
                public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
                    ...
                    if (random.nextInt(1000000) + 1 <= 5000) {
                        ...
                        for (int a = 0; a < count; ++a) {
                            ...
                            if (blockAt.getBlock() == MoCBlocks.silverSand) {
                                blockCriteria = true;
                            }
                            ...
                            int y = spawnTo.getY();
                            int z = spawnTo.getZ();
                            Template template = world.getWorld().getStructureTemplateManager().getTemplate(new ResourceLocation("mocreatures", "ruin3"));
                            if (template == null) {
                                return false;
                            }
            ...
            event.getRegistry().register(feature.setRegistryName("ruin_3"));
            Registry.register((Registry) WorldGenRegistries.CONFIGURED_FEATURE, (ResourceLocation)new ResourceLocation("mocreatures:ruin_3"), (Object)configuredFeature);
        }
    }
}
