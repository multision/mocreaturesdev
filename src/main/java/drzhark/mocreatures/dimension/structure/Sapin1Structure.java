...
public class Sapin1Structure {
    ...
    private static class FeatureRegisterHandler {
        ...
        public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
                ...
                public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
                    ...
                    if (random.nextInt(1000000) + 1 <= 250000) {
                        ...
                        for (int a = 0; a < count; ++a) {
                            ...
                            int y = spawnTo.getY();
                            int z = spawnTo.getZ();
                            Template template = world.getWorld().getStructureTemplateManager().getTemplate(new ResourceLocation("mocreatures", "sapin"));
                            if (template == null) {
                                return false;
                            }
            ...
            event.getRegistry().register(feature.setRegistryName("sapin_1"));
            Registry.register((Registry) WorldGenRegistries.CONFIGURED_FEATURE, (ResourceLocation)new ResourceLocation("mocreatures:sapin_1"), (Object)configuredFeature);
        }
    }
}
