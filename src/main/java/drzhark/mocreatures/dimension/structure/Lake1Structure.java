...
public class Lake1Structure {
    ...
    private static class FeatureRegisterHandler {
        ...
        public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
                ...
                public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
                    ...
                    if (random.nextInt(1000000) + 1 <= 40000) {
                        ...
                        for (int a = 0; a < count; ++a) {
                            ...
                            int y = spawnTo.getY();
                            int z = spawnTo.getZ();
                            Template template = world.getWorld().getStructureTemplateManager().getTemplate(new ResourceLocation("mocreatures", "lake1"));
                            if (template == null) {
                                return false;
                            }
            ...
            event.getRegistry().register(feature.setRegistryName("lake_1"));
            Registry.register((Registry) WorldGenRegistries.CONFIGURED_FEATURE, (ResourceLocation)new ResourceLocation("mocreatures:lake_1"), (Object)configuredFeature);
        }
    }
}