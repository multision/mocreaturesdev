...
public class Ile3Structure {
    ...
    private static class FeatureRegisterHandler {
        ...
        public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
                ...
                public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
                    ...
                    if (random.nextInt(1000000) + 1 <= 30000) {
                        ...
                        for (int a = 0; a < count; ++a) {
                            ...
                            int y = spawnTo.getY();
                            int z = spawnTo.getZ();
                            Template template = world.getWorld().getStructureTemplateManager().getTemplate(new ResourceLocation("mocreatures", "ile3"));
                            if (template == null) {
                                return false;
                            }
            ...
            event.getRegistry().register(feature.setRegistryName("ile_3"));
            Registry.register((Registry)WorldGenRegistries.CONFIGURED_FEATURE, (ResourceLocation)new ResourceLocation("mocreatures:ile_3"), (Object)configuredFeature);
        }
    }
}
