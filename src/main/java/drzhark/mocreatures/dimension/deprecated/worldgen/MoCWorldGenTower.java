...
//
//public class MoCWorldGenTower extends WorldGenerator {
//
//    private final Block MainBlock;
//    private final Block brickBlock;
//
//    public MoCWorldGenTower(Block Main, Block Brick, Block Deco) {
//        this.MainBlock = Main;
//        this.brickBlock = Brick;
//    }
//
//    public MoCWorldGenTower(Block Main, int MainMeta, Block Brick, int BrickMeta, Block Deco, int DecoMeta) {
//        this.MainBlock = Main;
//        this.brickBlock = Brick;
//    }
//
